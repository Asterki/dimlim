    ...
    return (
        <div className="bg-gray-800 min-h-screen text-white">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-gray-700 rounded-md p-4 w-11/12 md:w-4/12">
                <form>
                    <h1 className="text-2xl font-semibold mb-2">Register to DIMLIM</h1>

                    <div className="my-4">
                        <label>Name</label>
                        <input type="text" className="w-full p-2 bg-gray-800 border-2 border-gray-800 outline-none rounded-md transition-all focus:border-blue-400" />
                    </div>
                    ...
                    <div className="mt-8">
                        <button className="w-full p-2 bg-blue-500 rounded-md">Register</button>
                    </div>

                    <div className="mt-4">Already have an account? <a href="/login" className="text-blue-400">Login</a></div>
                </form>
            </div>
        </div>
    );
