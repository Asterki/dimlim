...
const template: typeof LangPack = {
        ...
        settings: {
            ...
            tabs: {
                ...
                account: {
                    ...
                    verifyEmail: {
                        title: "Verify email",
                        description: "Verify your email to unlock more security features"
                    },
            ...
            dialogs: {
                account: {
                    ...
                    verifyEmail: {
                        title: "Verify Email",
                        description: "We'll send you a link to verify your email at your current email",
                    ...
                    verifyEmailSent: {
                        title: "Email sent",
                        description: "We sent you an email to {email}, you have 5 minutes to verify your email",
                        close: "Close"
                    },
    ...
    accounts: {
        ...
        verifyEmail: {
            ...
            expired: "The code you provided already expired.",
            "invalid-code": "The code you provided is invalid or doesn't belong to any account.",
